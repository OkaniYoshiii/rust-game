...
pub fn draw_home_tile(canvas: &mut Canvas, ctx: &mut Context, screen_pos: Vector2<f32>) -> GameResult {
...
pub fn draw_empty_tile(canvas: &mut Canvas, ctx: &mut Context, screen_pos: Vector2<f32>) -> GameResult {
...
pub fn tile_position(origin: &Vector2<f32>, tile_pos: &Vector2<i32>) -> Vector2<f32> {
